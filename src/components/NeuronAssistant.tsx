    ...
    <>
      ...
      <div className={`fixed bottom-6 right-6 z-50 transition-all duration-300 ${isOpen ? 'scale-0' : 'scale-100'}`}>
        <button
          ...
          className="group relative w-16 h-16 bg-gradient-to-r from-emerald-600 to-blue-600 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 flex items-center justify-center"
        >
          <div className="absolute inset-0 bg-gradient-to-r from-emerald-600 to-blue-600 rounded-full animate-pulse opacity-75"></div>
      ...
      <div className={`fixed inset-0 z-40 transition-all duration-300 ${isOpen ? 'opacity-100 visible' : 'opacity-0 invisible'}`}>
        ...
        <div className={`absolute bottom-6 right-6 w-96 h-[600px] transition-all duration-500 ease-out ${
          ...
          <div className="bg-white/10 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/20 h-full flex flex-col overflow-hidden">
            {/* Header */}
            <div className="bg-gradient-to-r from-emerald-600/90 to-blue-600/90 p-4 flex items-center justify-between">
                ...
                >
                  <div className={`flex items-start space-x-2 max-w-[80%] ${
                    ...
                    <div className={`rounded-2xl px-4 py-3 text-sm ${
                      message.type === 'user'
                        ? 'bg-gradient-to-r from-emerald-600 to-pink-600 text-white rounded-br-md'
              ...
              <div className="flex space-x-2">
                <div className="flex-1 relative">
                  <input
                    ...
                    className="w-full bg-white/10 border border-white/20 rounded-full px-4 py-3 text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-transparent transition-all"
                    disabled={isTyping}
                  />
                </div>
                <button
                  ...
                  className="w-12 h-12 bg-gradient-to-r from-emerald-600 to-blue-600 hover:from-emerald-700 hover:to-blue-700 disabled:opacity-50 disabled:cursor-not-allowed rounded-full flex items-center justify-center transition-all duration-200 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-emerald-500/50"
                >
