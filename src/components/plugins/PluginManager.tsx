...
module.exports = {
  ...
  "scripts": {
    ...
    "deploy:testnet": "npx hardhat ignition deploy ./ignition/modules/Deploy.js --network westendHub",
    "verify": "npx hardhat verify --network westendHub",
...
- \`npm run deploy:testnet\` - Deploy to Westend testnet
...
export const deployContract = async ({
  ...
  try {
    ...
    console.log(\`💰 Wallet balance: \${formatEther(balance)} WND\`);
