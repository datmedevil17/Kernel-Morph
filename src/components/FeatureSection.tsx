...
const Feature = ({
  ...
  return (
    <div
      className={cn(
        "flex flex-col lg:border-r py-10 relative group/feature dark:border-purple-900 border-purple-200",
    ...
    >
      ...
      {/* Description */}
      <p className="text-sm text-purple-200 max-w-xs relative z-10 px-10">
        {description}
      </p>
    </div>
  );
