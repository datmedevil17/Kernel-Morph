        ...
        <div key={suggestion.id} className="bg-gray-900/80 backdrop-blur-sm border border-gray-800 rounded-xl p-5 hover:shadow-purple-900/20 transition-all">
          <div className="flex items-start justify-between mb-3">
            ...
            <div className="flex flex-col items-end space-y-2">
              <div className={`px-2.5 py-1 rounded-full text-xs font-bold ${getImpactColor(suggestion.impact || 'low')}`}>
        ...
        <div className="bg-gray-900/80 backdrop-blur-sm border border-gray-800 rounded-xl p-6 shadow-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {Object.entries(safeAnalytics.complexity).map(([key, value], index) => (
              <div key={`complexity-${key}-${index}`} className="bg-gray-800/50 p-4 rounded-lg">
        ...
        <div className="bg-gray-900/80 backdrop-blur-sm border border-gray-800 rounded-xl p-6 shadow-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {Object.entries(safeAnalytics.codeQuality).map(([key, value], index) => (
              <div key={`quality-${key}-${index}`} className="bg-gray-800/50 p-4 rounded-lg">
                <p className="text-xs uppercase tracking-wider text-purple-300 mb-1">{key}</p>
        ...
        <div className="bg-gray-900/80 backdrop-blur-sm border border-gray-800 rounded-xl p-6 shadow-lg">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            {Object.entries(safeAnalytics.metrics).map(([key, value], index) => (
              <div key={`metrics-${key}-${index}`} className="bg-gray-800/50 p-4 rounded-lg">
