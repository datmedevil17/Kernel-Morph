...
const nodeTypes: Record<string, NodeType> = {
  ...
  deploy: { icon: GitBranch, color: "bg-purple-800", label: "Deploy EVM" },
  ...
  return (
    <div className="h-screen bg-black flex text-white">
      ...
      <div className="w-64 bg-gray-900 border-r border-gray-800 p-4 overflow-y-auto">
        <h3 className="text-lg font-semibold mb-4 text-white">Solidity Pipeline</h3>
          ...
          <div className="space-y-2">
            {Object.entries(templates).map(([key, template]) => (
              <button
                ...
                className="w-full text-left p-2 text-sm bg-purple-600/20 hover:bg-purple-600/30 rounded border border-purple-500/30 text-purple-200 transition-all duration-200"
              >
                {template.name}
              </button>
            ))}
          ...
          {Object.entries(nodeTypes).map(([type, config]) => {
            ...
            return (
              <div
                ...
                className="flex items-center gap-2 p-3 bg-gray-800 border border-gray-700 rounded cursor-move hover:bg-gray-700 hover:border-purple-500/50 transition-all duration-200 hover:shadow-lg hover:shadow-purple-500/20"
              >
                <div className={`p-2 rounded ${config.color} shadow-lg`}>
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="flex-1 flex">
          ...
          {executionLogs.length > 0 && (
            <div className="w-80 bg-black border-l border-gray-800 p-4 font-mono text-sm overflow-y-auto">
              <h3 className="text-purple-400 mb-2 font-semibold">Execution Logs</h3>
